...
export declare const isPosInRotationRect: (point: {
    x: number;
    y: number;
}, shape: any, hornRadinCenter?: {
    x: number;
    y: number;
}) => boolean;
export declare const Reverse: (data: any, i: number) => void;
export declare const BackWhite: (data: any, i: number) => void;
